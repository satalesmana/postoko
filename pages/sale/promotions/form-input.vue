<template>
  <div class="q-ma-lg">
    <CustomeTitle icon="font_download" label="Promotions" />
      ...
      <q-item class="bg-grey-4">
        <q-item-section>
          <q-item-label class="row no-wrap items-center">
            ...
            <span class="text-bold">Promotions Form</span>
          </q-item-label>
        </q-item-section>
      </q-item>
      <q-separator />
        ...
        <ClientOnly fallback-tag="span" fallback="Loading component...">
          ...
          >
            <div class="row q-mb-sm items-center">
              ...
              >
                <label class="text-bold">Promo Name </label>
              </div>
            ...
            <div class="row q-mb-sm items-center">
              <div
                class="text-right q-pr-md col-lg-3 col-md-3 col-sm-3 col-xs-12"
              >
                <label class="text-bold">Percentage (%) </label>
              </div>
              <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                <span class="custom-input">
                  <q-input outlined dense hide-bottom-space requird />
